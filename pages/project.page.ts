...
export class ProjectPage {
  ...
  //Locators
  projectNavItem = 'body > div.main-grid > nav > div:nth-child(1) > div:nth-child(2) > a'
  ...
  lastProjectAdded = 'project-list > div > div > div:nth-child(2) > div:nth-child(2) > div > div> div > a';
  ...
  enPluralOtherBtn = '[data-lang-id="640"] [data-lokalise-editor-plural="other"]'

  ptPluralOneBtn = '[data-lang-id="1057"] [data-lokalise-editor-plural="one"]'
  ptPluralOtherBtn = '[data-lang-id="1057"] [data-lokalise-editor-plural="other"]'
